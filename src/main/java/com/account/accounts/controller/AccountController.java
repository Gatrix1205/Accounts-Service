...
import com.account.accounts.dto.ErrorResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in IDFCBank",
...
public class AccountController {
    ...
    @Operation(
            summary = "Get Mapping for build info versioning",
    ...
    @Operation(
            summary = "Get Mapping for Java info versioning",
            description = "REST API to Java build version"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
